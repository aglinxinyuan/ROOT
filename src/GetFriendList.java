...
@WebServlet(name = "GetFriendList", urlPatterns = "/api/friendlist")
public class GetFriendList extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try (Connection conn = dataSource.getConnection()) {
            ...
            ResultSet rs = statement.executeQuery("SELECT * FROM ezcross.user INNER JOIN ezcross.friends on ezcross.user.id = ezcross.friends.friend_id WHERE ezcross.friends.user_id="+user.GetId()+" ORDER BY ezcross.user.name ASC;");
