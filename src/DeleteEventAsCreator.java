...
@WebServlet(name = "DeleteEventAsCreator", urlPatterns = "/api/deleteEventAsCreator")
public class DeleteEventAsCreator extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try (Connection conn = dataSource.getConnection()) {
            String query = "DELETE FROM ezcross.event WHERE id ="+id+";";
