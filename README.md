...
3. For "Root Directory", right click "login-cart-example" -> Mark Directory as -> sources root
4. In Tomcat Deployment Configuration, make sure the application context is: /login-cart-example
5. To run the example, follow the instructions in . The default username is `anteater` and password is `123456` .
